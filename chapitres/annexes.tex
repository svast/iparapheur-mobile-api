...
\begin{codesnippet}
\inputminted[frame=single,linenos,fontsize=\footnotesize]{javascript}{extraits/getArchives_out.js}
\caption{getArchives requête sortante}
\label{snip:getArchives_out}
\end{codesnippet}
